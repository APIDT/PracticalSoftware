...
from django.urls import reverse # Можливо, знадобиться пізніше, поки можна без нього, але є в документі
# from django.db.models.functions import Now # Згадується, але в фінальному коді не використовується тут
...
class Article (models.Model):
    ...
    objects = models.Manager() # Явно визначений менеджер, хоча є за замовчуванням
    ...
    def get_absolute_url(self):
        try:
            # Приклад URL, можливо знадобиться налаштування URLconf пізніше
